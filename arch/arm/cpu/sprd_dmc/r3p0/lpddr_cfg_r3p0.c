...
DMC_LOCAL_TIMING_CFG dmc_local_timing_lpddr3[] = {
	...
	533,
	{
		...
		0x03FF0008,	/*dtmg8 ,data_ie_sel[31:16]	data_ie_dly[4:0]*/
		0x03FF0008,	/*dtmg9 ,dqs_ie_sel[31:16]		dqs_ie_dly[4:0]*/
#else
...
int update_cs_num(void)
{
	...
	//added by roger
	dmc_print_str("roger begin cs_num ==");
 	ddr_print_char(cs_num);
	dmc_print_str(" end\r\n");
	if(cs_num>1)
	{
		cs_num =1;//
...
#else
#ifdef LP2_DIE_LP3_SWAP_EMCP_LP3_T_SUPPORT
...
#else
#ifdef LP3_DIE_LP2_SWAP_EMCP_LP2_T_SUPPORT
