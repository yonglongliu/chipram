...
#define MEM_FW_SEG_OFFSET		(0x1000)
...
#define SD0_RD_SEC	(BIT(7)|BIT(6))
#define SD0_WR_SEC	(BIT(7)|BIT(6))

#define SD1_RD_SEC	(BIT(5)|BIT(4))
#define SD1_WR_SEC	(BIT(5)|BIT(4))

#define SD2_RD_SEC	(BIT(3)|BIT(2))
#define SD2_WR_SEC	(BIT(3)|BIT(2))

#define USB_RD_SEC	(BIT(10)|BIT(11))
#define USB_WR_SEC	(BIT(10)|BIT(11))
...
#define DDR1_ATTR_MASK	(BIT(23)|BIT(22))
#define DDR1_ATTR_RD	(0x3 << 22)	//security/non_security accesss
#define DDR1_ATTR_WR	(0x1 << 22)	//security access only

#define DDR0_ATTR_MASK	(BIT(25)|BIT(24))
#define DDR0_ATTR_RD	(0x3 << 24)	//security/non_security accesss
#define DDR0_ATTR_WR	(0x1 << 24)	//security access only
...
static void sd_unsec(void)
{
	...
	REG32(SPRD_MST_CTRL_AP_BASE + MST_CTRL_AP_RD0_OFF) &= ~SD0_RD_SEC;
	REG32(SPRD_MST_CTRL_AP_BASE + MST_CTRL_AP_WR0_OFF) &= ~SD0_WR_SEC;
	REG32(SPRD_MST_CTRL_AP_BASE + MST_CTRL_AP_RD0_OFF) &= ~SD1_RD_SEC;
	REG32(SPRD_MST_CTRL_AP_BASE + MST_CTRL_AP_WR0_OFF) &= ~SD1_WR_SEC;
	REG32(SPRD_MST_CTRL_AP_BASE + MST_CTRL_AP_RD0_OFF) &= ~SD2_RD_SEC;
	REG32(SPRD_MST_CTRL_AP_BASE + MST_CTRL_AP_WR0_OFF) &= ~SD2_WR_SEC;
}
...
static void ddr_controller_sec (void)
{
	...
	*(volatile uint32_t*)(SPRD_SLV_FW_AON_BASE + SLV_FW_AON_WR3_OFF) &= ~DDR0_ATTR_MASK;
	*(volatile uint32_t*)(SPRD_SLV_FW_AON_BASE + SLV_FW_AON_WR3_OFF) |= DDR0_ATTR_WR;

	*(volatile uint32_t*)(SPRD_SLV_FW_AON_BASE + SLV_FW_AON_WR3_OFF) &= ~DDR1_ATTR_MASK;
	*(volatile uint32_t*)(SPRD_SLV_FW_AON_BASE + SLV_FW_AON_WR3_OFF) |= DDR1_ATTR_WR;
	/* enable mem_fw_pub, */
