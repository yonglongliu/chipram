...
#if defined (CONFIG_WHALE)|| defined (CONFIG_WHALE2)|| defined (CONFIG_SOC_SHARKLJ1) || defined (CONFIG_SOC_SHARKLE) || defined (CONFIG_SOC_SHARKL3) || defined (CONFIG_SOC_WHALEK)
