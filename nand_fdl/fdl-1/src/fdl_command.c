...
#ifndef CONFIG_X86
#if defined CONFIG_SC8825 || defined CONFIG_SC8830 || defined(CONFIG_SC9630) || defined(CONFIG_SCX35L64) ||defined(CONFIG_WHALE)|| defined (CONFIG_WHALE2) \
			|| defined (CONFIG_SOC_SHARKLJ1) || defined (CONFIG_SOC_SHARKLE) || defined (CONFIG_SOC_SHARKL3) || defined(CONFIG_SOC_WHALEK)
...
#if defined (CONFIG_WHALE) ||defined (CONFIG_WHALE2) || defined (CONFIG_X86)|| defined (CONFIG_SOC_SHARKLJ1) || defined (CONFIG_SOC_SHARKLE) || defined (CONFIG_SOC_SHARKL3) || defined(CONFIG_SOC_WHALEK)
...
#if defined (CONFIG_WHALE) ||defined (CONFIG_WHALE2)|| defined (CONFIG_SOC_SHARKLJ1)|| defined (CONFIG_ARCH_SCX35L2) || defined (CONFIG_SOC_PIKE2) || defined (CONFIG_SOC_SHARKLE) || defined (CONFIG_SOC_IWHALE2) || defined (CONFIG_SOC_SHARKL3) || defined(CONFIG_SOC_WHALEK)
...
#define FDL1_DDR_TSET_RESERVE_START	 0x8EF000
#define FDL1_DDR_TSET_RESERVE_END	 0x8F0000

extern int sdram_test(int start, int end);
int fdl1_ddr_test (void)
{
	if(0 != sdram_test(FDL1_DDR_TSET_RESERVE_START, FDL1_DDR_TSET_RESERVE_END))
		return -1;
	return 0;
}
